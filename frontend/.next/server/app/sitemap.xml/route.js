"use strict";(()=>{var e={};e.id=717,e.ids=[717],e.modules={8013:e=>{e.exports=require("mongodb")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3207:(e,t,r)=>{let o,i;r.r(t),r.d(t,{originalPathname:()=>w,patchFetch:()=>y,requestAsyncStorage:()=>h,routeModule:()=>u,serverHooks:()=>g,staticGenerationAsyncStorage:()=>d});var a={};r.r(a),r.d(a,{GET:()=>m});var n=r(9303),s=r(8716),l=r(670),p=r(8013);async function c(){return o||(o=new p.MongoClient(process.env.MONGO_URL),await o.connect(),i=o.db(process.env.DB_NAME||"iltmc")),i}async function m(){let e=process.env.NEXT_PUBLIC_BASE_URL||"https://iltmc.com";try{let t=await c();await t.collection("members").find({status:{$in:["active","veteran"]}}).toArray(),await t.collection("rides").find({isPublic:!0}).toArray(),await t.collection("events").find({isPublic:!0}).toArray();let r=await t.collection("blog").find({published:!0}).toArray(),o=new Date().toISOString().split("T")[0],i=`<?xml version="1.0" encoding="UTF-8"?>
